...
-- CreateEnum
CREATE TYPE "PaymentType" AS ENUM ('COD', 'BKASH', 'NAGAD', 'ROCKET', 'CARD', 'INTERNET_BANKING');
...
-- CreateIndex
CREATE UNIQUE INDEX "carts_userId_productId_size_key" ON "carts"("userId", "productId", "size");
